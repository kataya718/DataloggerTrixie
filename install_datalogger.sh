...
if stel_vraag "Stap 6: Cronjobs instellen in jouw persoonlijke crontab?"; then
    ...
    echo "1,16,31,46 * * * * /home/pi05/pythonscripts/dhtvenv/bin/python /home/pi05/pythonscripts/MatplotlibDagTemperatuur.py" >> temp_cron
    echo "1,16,31,46 * * * * /home/pi05/pythonscripts/dhtvenv/bin/python /home/pi05/pythonscripts/MatplotlibDagVochtigheid.py" >> temp_cron
    echo "1,16,31,46 * * * * /home/pi05/pythonscripts/dhtvenv/bin/python /home/pi05/pythonscripts/MatplotlibWeekTemperatuur.py" >> temp_cron
    echo "1,16,31,46 * * * * /home/pi05/pythonscripts/dhtvenv/bin/python /home/pi05/pythonscripts/MatplotlibWeekVochtigheid.py" >> temp_cron
    echo "1,16,31,46 * * * * /home/pi05/pythonscripts/dhtvenv/bin/python /home/pi05/pythonscripts/MatplotlibMaandTemperatuur.py" >> temp_cron
    echo "1,16,31,46 * * * * /home/pi05/pythonscripts/dhtvenv/bin/python /home/pi05/pythonscripts/MatplotlibMaandVochtigheid.py" >> temp_cron
    echo "" >> temp_cron
    echo "# Elke 15 minuten de afbeelding kopiëren naar webroot" >> temp_cron
    echo "2,17,32,47 * * * * sudo cp /home/pi05/DagTemperatuur.png /var/www/html/" >> temp_cron
    echo "2,17,32,47 * * * * sudo cp /home/pi05/DagVochtigheid.png /var/www/html/" >> temp_cron
    echo "2,17,32,47 * * * * sudo cp /home/pi05/WeekTemperatuur.png /var/www/html/" >> temp_cron
    echo "2,17,32,47 * * * * sudo cp /home/pi05/WeekVochtigheid.png /var/www/html/" >> temp_cron
    echo "2,17,32,47 * * * * sudo cp /home/pi05/MaandTemperatuur.png /var/www/html/" >> temp_cron
    echo "2,17,32,47 * * * * sudo cp /home/pi05/MaandVochtigheid.png /var/www/html/" >> temp_cron
